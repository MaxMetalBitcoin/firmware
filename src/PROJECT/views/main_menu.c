...
static void btn_event_cb1(lv_obj_t *btn, lv_event_t event)
{
  if (event == LV_EVENT_CLICKED)
  {
    ...
    lv_label_set_text_fmt(label, "Button clicked: %d", cnt);
  }
}
...
void mmbtc_main_menu_render(void)
{
  ...
  lv_obj_set_event_cb(btn, btn_event_cb1);
  lv_obj_set_event_cb(btn2, btn_event_cb2);
